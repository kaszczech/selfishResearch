...
if __name__ == '__main__':
    ...
    args.add_argument('--rewardType', type=str, default='FAIR')
    ...
    rewardType = args.pop('rewardType')
    ...
    def normalize_rewards(env, agent_num):
        ...
        if rewardType == "THR":
            ...
            reward = throughput
            print("agent num: ", agent_num, " reward: ", reward, "THR: ", env.throughput[agent_num], "MBS")
            ...
            if env.time != 0:
                # reward = 1 + (((1/10) - (env.txTime[agent_num] / 0.5)) * 10)
